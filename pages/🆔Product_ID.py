...
pfa=dat.copy()
st.title("Product Approval Portal - Index")
pfa=pfa[pfa["Product_live_status"]==0]#filtering Product live status ==0
with st.expander("All Unapproved Products", expanded=False):
        st.write(pfa)
...
if index!=0:    
    ...
    if product_imagesR != "NA" and product_imagesR != "" :
        ...
        st.write(product_imagesR)
        st.image(product_imagesR,width=100,caption=list(range(1,len(product_imagesR)+1)))

    else:
        st.write("No images uploaded")
    imagesrembg=["https://abo5.s3.eu-central-1.amazonaws.com/2022-06-20135523994661.png","https://abo5.s3.eu-central-1.amazonaws.com/2022-06-20135523994661.png","https://abo5.s3.eu-central-1.amazonaws.com/2022-06-20135523994661.png"]
